...
model.fit(train_x, train_y, nb_epoch=5000, batch_size=512, verbose=2)
...
y_df_train.to_sql('lstm_madness_xlf_train_01_02', engine)
...
plot_title = "XLF LSTM Train TS: 1, N: 1, BS: 512, E: 5000"

# Plot scatterplot 
plot_query = """
SELECT * 
FROM lstm_madness_xlf_train_01_02
ORDER BY index
"""
