...
model = Sequential()
model.add(LSTM(32, input_dim=number_of_features))
model.add(Dense(1))
model.compile(loss='mean_squared_error', optimizer='adam')
model.fit(train_x, train_y, nb_epoch=100, batch_size=32, verbose=2)
...
y_df_train.to_sql('lstm_madness_xlf_train_02', engine)
...
plot_title = "XLF LSTM Train lookback: 1, neurons: 32"

# Plot scatterplot 
plot_query = """
SELECT * 
FROM lstm_madness_xlf_train_02
ORDER BY index
"""
