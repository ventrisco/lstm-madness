...
d = 0.2
model = Sequential()
model.add(LSTM(128, input_dim=number_of_features, return_sequences=False))
model.add(Dropout(d))       
...
y_df_train.to_sql('lstm_madness_xlf_train_02_02', engine)
...
plot_title = "XLF LSTM Train lookback: 1, neurons: 128"

# Plot scatterplot 
plot_query = """
SELECT * 
FROM lstm_madness_xlf_train_02_02
ORDER BY index
"""
